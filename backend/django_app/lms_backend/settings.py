"""
Django settings for LMS Backend
"""
import os
...
INSTALLED_APPS = [
    ...
    'django_filters',
    'drf_spectacular',
    # Local apps — use full AppConfig path to avoid label collisions
...
# Use Redis cache when available, fall back to local memory cache
try:
...
try:
    from lms_backend.beat_schedule import CELERY_BEAT_SCHEDULE  # noqa: F401
except ImportError:
    pass
...
# Email — uses console backend in DEBUG mode (no SMTP server needed)
if DEBUG:
